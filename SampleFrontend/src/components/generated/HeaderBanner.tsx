...
export default function HeaderBanner({
  ...
  return <header className={cn("w-full max-w-[800px] mx-auto", "bg-gradient-to-r from-pink-500 via-purple-500 to-cyan-500", "border-8 border-double border-yellow-400", "p-6 text-center", "shadow-2xl", "font-['Comic_Sans_MS',_cursive]")} style={{
    ...
    backgroundImage: `
        ...
        `
  }} role="banner" aria-label="結婚式招待ヘッダー">
      {/* Main Heading */}
      <h1 className={cn("text-6xl font-black text-white mb-4", "font-mono tracking-wider")} style={{
      textShadow: `
            3px 3px 0px #000,
            -1px -1px 0px #000,
            1px -1px 0px #000,
      ...
      {/* Couple Names with Blinking Effect */}
      <div className={cn("text-4xl font-bold text-yellow-300 mb-6", "animate-pulse")} style={{
      textShadow: `
            2px 2px 0px #000,
            -1px -1px 0px #000,
            1px -1px 0px #000,
      ...
      {/* Marquee Wedding Date */}
      <div className={cn("bg-black/80 border-4 border-solid border-green-400 p-3 rounded-lg", "overflow-hidden whitespace-nowrap")} style={{
      boxShadow: `
            0 0 15px rgba(0,255,0,0.8),
            inset 0 0 10px rgba(0,255,0,0.3)
          `
    }}>
        <div className={cn("text-2xl font-bold text-green-400", "inline-block")} style={{
        textShadow: `
              1px 1px 0px #000,
